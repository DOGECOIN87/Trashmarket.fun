...
const NFTCard: React.FC<NFTCardProps> = ({ nft, collectionName, isSelected, onToggle, isNetworkCompatible = true }) => {
  ...
  const handleImageError = () => {
    if (imgSrc !== '/assets/nft-placeholder.svg') {
  ...
  return (
    <div
      onClick={onToggle}
      className={`group relative bg-magic-card cursor-pointer border transition-all duration-200 ease-out hover:scale-[1.02] ${hoverShadow} hover:z-20 ${isSelected
