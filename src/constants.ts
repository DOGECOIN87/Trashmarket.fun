...
export const MOCK_COLLECTIONS: Collection[] = [
  ...
  },
  {
    id: 'gorbagios',
    name: 'GORBAGIO',
    description: 'The Gorbagio collection — 4,444 unique NFTs on Solana. Literal garbage bags living on the blockchain.',
    image: 'https://plum-far-bobcat-940.mypinata.cloud/ipfs/bafybeihkdrontwttwgcaqlpifsav2pvyzyi2m4otl2jeklp4dbdzasdcu4/1.png',
    banner: 'https://plum-far-bobcat-940.mypinata.cloud/ipfs/bafybeihkdrontwttwgcaqlpifsav2pvyzyi2m4otl2jeklp4dbdzasdcu4/1.png',
    floorPrice: 0.189,
    totalVolume: 12528,
    listedCount: 354,
    supply: 4444,
