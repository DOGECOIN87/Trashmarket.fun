...
const FilterContent: React.FC<FilterContentProps> = ({ accentColor, currency, borderFocus }) => (
        ...
        <div className="fixed inset-0 z-50 flex lg:hidden">
          ...
          <div className="relative w-[85%] max-w-sm bg-black border-r border-white/20 h-full flex flex-col animate-in slide-in-from-left duration-200">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              <FilterContent accentColor={accentColor} currency={currency} borderFocus={borderFocus} />
            </div>
